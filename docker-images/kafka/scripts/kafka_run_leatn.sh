...
# KAFKA_LOG4J_OPTS KAFKA_METRICS_ENABLED=true /opt/kafka/kafka_run.sh
...
# KAFKA_LOG_BASE_NAME=kafka-log

export KAFKA_APP_LOGS_BASE_NAME="logs"
# KAFKA_APP_LOGS_BASE_NAME=logs
...
# CERTS_STORE_PASSWORD=Bvs8ejyKrN2TV0NUVITqnmGslgy_Umol
