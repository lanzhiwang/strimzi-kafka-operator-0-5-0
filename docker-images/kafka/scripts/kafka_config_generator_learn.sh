...
# KAFKA_NAME=a498be34ca0e

ASSEMBLY_NAME=$(echo "${KAFKA_NAME}" | rev | cut -d "-" -f2- | rev)
# a498be34ca0e | rev | cut -d - -f2- | rev
# ASSEMBLY_NAME=a498be34ca0e

SUPER_USERS="super.users=User:CN=${ASSEMBLY_NAME}-topic-operator,O=io.strimzi;User:CN=${KAFKA_NAME},O=io.strimzi"
# SUPER_USERS='super.users=User:CN=a498be34ca0e-topic-operator,O=io.strimzi;User:CN=a498be34ca0e,O=io.strimzi'
